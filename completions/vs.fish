...
complete --command vs --exclusive --condition "__fish_seen_subcommand_from open delete rm" --arguments "(vs list)" 
complete --command vs --exclusive --condition "__fish_seen_subcommand_from init rename mv" --arguments "(vs _list_all)"
